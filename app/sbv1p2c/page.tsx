...
// /sbv1p2c — Copper/Leather redesign. Scope: landing page only. See
// docs/sbv1p2c-copy-deck.md for the copy source of truth and
...
function trackPixel(
  ...
  fetch("/api/pixel-event", {
    ...
    body: JSON.stringify({
      ...
      landing_page:
        landingPage || (typeof window !== "undefined" ? window.location.pathname : "/sbv1p2c"),
      source: "client",
    }),
  }).catch(() => {});
}
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (params.get("demo") === "true") {
      ...
      window.history.replaceState({}, "", "/sbv1p2c");
    }
