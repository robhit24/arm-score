...
// /sbv1p1c — Copper/Leather redesign. Scope: landing page only. See
// docs/sbv1p1c-copy-deck.md for the copy source of truth and
...
function trackPixel(
  ...
  fetch("/api/pixel-event", {
    ...
    body: JSON.stringify({
      ...
      landing_page:
        landingPage || (typeof window !== "undefined" ? window.location.pathname : "/sbv1p1c"),
      source: "client",
    }),
  }).catch(() => {});
}
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (params.get("demo") === "true") {
      ...
      window.history.replaceState({}, "", "/sbv1p1c");
    }
            ...
            <div className={s.plansInner}>
              <div className={s.planGrid}>
                <PlanCard
                  ...
                  onClick={() => buyPlan(7, 9.99, "7-Day Quick Fix")}
                />
                <PlanCard
                  tier="14-Day Fix"
                  badge="Most chosen"
