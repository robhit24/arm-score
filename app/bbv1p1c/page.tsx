...
// /bbv1p1c — Copper/Leather redesign. Scope: landing page only. See
// docs/bbv1p1c-copy-deck.md for the copy source of truth and
...
function trackPixel(
  ...
  fetch("/api/pixel-event", {
    ...
    body: JSON.stringify({
      ...
      landing_page:
        landingPage || (typeof window !== "undefined" ? window.location.pathname : "/bbv1p1c"),
      source: "client",
    }),
  }).catch(() => {});
}
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (params.get("demo") === "true") {
      ...
      window.history.replaceState({}, "", "/bbv1p1c");
    }
